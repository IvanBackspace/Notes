...
function note (note, indexNote) {
    ...
    `<li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        <span class="btnNote">
            <span class="btn btn-outline-secondary" data-type="toggle" data-index="${indexNote}" id="edit"  data-bs-toggle="modal" data-bs-target="#staticBackdrop" type="button"><svg data-index="${indexNote}" data-type="toggle" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tools" viewBox="0 0 16 16">
            ...
            <span class="btn btn-outline-secondary" data-type="remove" data-index="${indexNote}" id="delete" type="button"><svg data-type="remove" data-index="${indexNote}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
